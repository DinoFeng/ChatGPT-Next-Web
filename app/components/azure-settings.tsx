          ...
          <div>
            <List>
              ...
              <ListItem title="Azure Deployment ID">
                <input
                  type="text"
                  value={accessStore.deploymentId}
                  onChange={(e) => {
                    accessStore.updateDeploymentId(e.currentTarget.value);
                  }}
                ></input>
              </ListItem>

              <ListItem title="Azure api version">
                <input
                  type="text"
                  value={accessStore.apiVersion}
                  onChange={(e) => {
                    accessStore.updateApiVersion(e.currentTarget.value);
                  }}
                ></input>
              </ListItem>
